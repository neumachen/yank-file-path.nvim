...
local function setup_mappings()
  ...
  vim.keymap.set(
    "n",
    "<leader>yrr",
    ":YankFilePath relative --range<CR>",
  ...
  vim.keymap.set(
    "n",
    "<leader>yar",
    ":YankFilePath absolute --range<CR>",
  ...
  vim.keymap.set(
    "n",
    "<leader>yfr",
    ":YankFilePath filename --range<CR>",
